...
from app.core.agent.kernel.workflow_agent.single_agent_workflow import SingleAgentRunnerMixin
...
from app.core.agent.savant_agent_runner import SavantSingleAgentRunnerMixin
from app.core.agent.savant_agent_persona import SavantAgentPersonaMixin


class SavantFunctionAgent(SavantSingleAgentRunnerMixin, SavantAgentPersonaMixin, BaseWorkflowAgent):
